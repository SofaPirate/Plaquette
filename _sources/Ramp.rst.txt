...
.. doxygenclass:: Ramp
   :project: Plaquette
   :members: Ramp, get, start, stop, pause, resume, elapsed, progress, isRunning, add, set, isFinished, go, easing, noEasing, to, from, fromTo, duration, speed, mode, onFinish, clearEvents
