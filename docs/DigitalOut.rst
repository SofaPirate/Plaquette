...
.. doxygenclass:: DigitalOut
   :project: Plaquette
   :members: DigitalOut, on, off, toggle, isOn, isOff, smooth, noSmooth, get, getInt, put, pin, mode, rose, fell, changed, changeState, onRise, onFall, onChange, clearEvents, write, rawWrite
