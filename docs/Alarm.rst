...
.. doxygenclass:: Alarm
   :project: Plaquette
   :members: Alarm, isOn, isOff, getInt, get, start, stop, pause, resume, elapsed, progress, isRunning, add, set, isFinished, duration, onRise, onFall, onChange, onFinish, clearEvents
