...
.. doxygenclass:: TriangleWave
   :project: Plaquette
   :members: SquareWave, get, period, frequency, width, phase, amplitude, bpm, mapTo, forward, reverse, toggleReverse, shiftBy, start, stop, pause, resume, isRunning, addTime, setTime
