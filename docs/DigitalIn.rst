...
.. doxygenclass:: DigitalIn
   :project: Plaquette
   :members: DigitalIn, isOn, isOff, pin, mode, getInt, get, debounce, noDebounce, debounceMode, rose, fell, changed, changeState, onRise, onFall, onChange, clearEvents, rawRead
