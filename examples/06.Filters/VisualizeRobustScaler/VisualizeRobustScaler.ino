/**
 * VisualizeRobustScaler
 *
 * Visualizes how a RobustScaler unit rescales a noisy signal.
 *
...
// Controls the span of the scaler: a span of 0.8 means that the scaler tries to place about 80% of
// the most common values between its lower and upper boundaries.
const float SPAN = 0.8; // try changing this to see the effect
